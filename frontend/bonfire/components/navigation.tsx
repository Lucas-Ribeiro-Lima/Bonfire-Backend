import { AlignJustify, LogIn, LucideHome, LucideImport, Settings } from "lucide-react";
...
const NavigationButton:FC<Buttons> = ({path, description, icon}) => {
    return(
        <Link className="flex gap-2  hover:text-white hover:duration-1000" href={path}> {icon}{description} </Link>
    );
}
