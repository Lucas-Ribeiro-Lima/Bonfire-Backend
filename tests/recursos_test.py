...
class TestRecursoRoutes:
    ...
    @patch("infrastructure.parsers.factory.ParserFactory.create_primeira_instancia_parser")
    ...
    @patch("infrastructure.parsers.factory.ParserFactory.create_segunda_instancia_parser")
